...
function remote(creds, options/*, request*/){
  ...
  return function logger(req, res, next){
    console.log('middleware called from zlogjs-express-logger!');
...
function _process(obj, creds, options){
  var base = obj.base;
   ...
   _sendRequest()({body:mbody, url:creds.host || creds.configs.host+base.input, timeout:creds.configs.timeout, method:"POST"}, function(err,res, data){  /*console.log(err ? err: data ? data : 'empty'); */ });
}
